...
public class GUICalculatorUpdate extends Frame implements ActionListener {
    private Label resultLabel;
    private String operator, secondNumberString;
    private double firstNumber, secondNumber;

    public GUICalculatorUpdate() {
        setTitle("Border Layout");

        Button button0, button1, button2, button3, button4, button5, button6, button7, button8, button9, addButton, subtractButton, divideButton, multiplyButton, computeButton, clearButton;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        button.getLabel().equals("-") ||
        button.getLabel().equals("/") ||
        button.getLabel().equals("*")) {
            firstNumber = Double.parseDouble(resultLabel.getText());
            operator = button.getLabel();
            resultLabel.setText(resultLabel.getText() + button.getLabel());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUICalculatorUpdate().setVisible(true);
            }
        });
    } 
}
