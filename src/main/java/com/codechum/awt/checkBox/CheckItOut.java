...
public class CheckItOut extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        chkFirst = new Checkbox();
        chkSecond = new Checkbox();
        chkThird = new Checkbox();
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(28, 28, 28)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(chkThird)
                            .addComponent(chkSecond)
                            .addComponent(chkFirst)
                            .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 235, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(73, 73, 73)
                        .addComponent(btnDisplayText, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnDisplayTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDisplayTextActionPerformed
        ...
        if (chkFirst.getState()) {
            display += "First";
        }
        
        if (chkSecond.getState()) {
            if (display.length() > 0) {
                display += ", Second";
            }
            else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CheckItOut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CheckItOut().setVisible(true);
            }
        });
    }
